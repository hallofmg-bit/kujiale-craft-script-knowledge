...
[GitHub 共享 Agent Skills](skills-共享技能/github-share-agent-skills/SKILL.md) 可指导 AI 工具完成：

- Git 官方安装与基础配置；
- GitHub 仓库上传、下载、更新和 PR 协作；
- 开放 Agent Skill 的制作、校验和脱敏；
- Codex、Claude Code、TRAE 等工具中的安装与套用。
